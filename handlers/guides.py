...
async def guides_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logger.info(f"User selected in Guides: {user_input}")
    ...
    if user_input == "🔙 Назад":
        ...
        # Тут можна додати логіку для відображення гайдів
        await update.message.reply_text("📖 Функція 'Гайди' ще не реалізована.")
