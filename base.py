...
async def handle_inline_buttons(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    if interactive_message_id:
        ...
        if data == "mls_button":
            await bot.answer_callback_query(callback.id, text="Ви натиснули кнопку MLS")
        elif data == "menu_back":
...
async def unknown_command(message: Message, state: FSMContext, bot: Bot):
    ...
    if current_state == MenuStates.MAIN_MENU.state:
        ...
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Персонажі."
        new_main_keyboard = get_heroes_menu()
        new_interactive_text = "Меню Персонажі"
        new_state = MenuStates.HEROES_MENU
    elif current_state == MenuStates.HERO_CLASS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню класу героїв."
        hero_class = data.get('hero_class', 'Танк')
        new_main_keyboard = get_hero_class_menu(hero_class)
        new_interactive_text = f"Меню класу {hero_class}"
        new_state = MenuStates.HERO_CLASS_MENU
    elif current_state == MenuStates.GUIDES_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Гайди."
        new_main_keyboard = get_guides_menu()
        new_interactive_text = "Меню Гайди"
        new_state = MenuStates.GUIDES_MENU
    elif current_state == MenuStates.COUNTER_PICKS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Контр-піки."
        new_main_keyboard = get_counter_picks_menu()
        new_interactive_text = "Меню Контр-піки"
        new_state = MenuStates.COUNTER_PICKS_MENU
    elif current_state == MenuStates.BUILDS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Білди."
        new_main_keyboard = get_builds_menu()
        new_interactive_text = "Меню Білди"
        new_state = MenuStates.BUILDS_MENU
    elif current_state == MenuStates.VOTING_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Голосування."
        new_main_keyboard = get_voting_menu()
        new_interactive_text = "Меню Голосування"
        new_state = MenuStates.VOTING_MENU
    elif current_state == MenuStates.PROFILE_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Профіль."
        new_main_keyboard = get_profile_menu()
        new_interactive_text = "Меню Профіль"
        new_state = MenuStates.PROFILE_MENU
    elif current_state == MenuStates.STATISTICS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Статистика."
        new_main_keyboard = get_statistics_menu()
        new_interactive_text = "Меню Статистика"
        new_state = MenuStates.STATISTICS_MENU
    elif current_state == MenuStates.ACHIEVEMENTS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Досягнення."
        new_main_keyboard = get_achievements_menu()
        new_interactive_text = "Меню Досягнення"
        new_state = MenuStates.ACHIEVEMENTS_MENU
    elif current_state == MenuStates.SETTINGS_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Налаштування."
        new_main_keyboard = get_settings_menu()
        new_interactive_text = "Меню Налаштування"
        new_state = MenuStates.SETTINGS_MENU
    elif current_state == MenuStates.FEEDBACK_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Зворотний Зв'язок."
        new_main_keyboard = get_feedback_menu()
        new_interactive_text = "Меню Зворотний Зв'язок"
        new_state = MenuStates.FEEDBACK_MENU
    elif current_state == MenuStates.HELP_MENU.state:
        new_main_text = "❗ Вибачте, я не розумію цю команду. Скористайтеся меню Допомога."
        new_main_keyboard = get_help_menu()
...
# Додайте обробники для інших меню (Статистика, Досягнення, Налаштування, Зворотний Зв'язок, Допомога тощо)
...
async def handle_search_hero(message: Message, state: FSMContext, bot: Bot):
    ...
    response_text = f"Ви шукаєте героя: {hero_name}. Ця функція ще в розробці."
...
async def handle_search_topic(message: Message, state: FSMContext, bot: Bot):
    ...
    response_text = f"Ви пропонуєте тему: {topic}. Ця функція ще в розробці."
...
async def handle_change_username(message: Message, state: FSMContext, bot: Bot):
    ...
    response_text = f"Ваш новий Username: {new_username} буде доданий після перевірки. Ця функція ще в розробці."
...
async def handle_receive_feedback(message: Message, state: FSMContext, bot: Bot):
    ...
    response_text = "Дякуємо за ваш відгук! Ми його розглянемо."
...
async def handle_report_bug(message: Message, state: FSMContext, bot: Bot):
    ...
    response_text = "Дякуємо за ваш звіт про помилку! Ми його розглянемо."
...
# Обробник натискання звичайних кнопок у підрозділі "Налаштування"
@router.message(MenuStates.SETTINGS_MENU)
async def handle_settings_menu_buttons(message: Message, state: FSMContext, bot: Bot):
    user_choice = message.text
    logger.info(f"Користувач {message.from_user.id} обрав {user_choice} в меню Налаштування")
...
# Обробник для отримання Username
@router.message(MenuStates.CHANGE_USERNAME)
async def handle_change_username(message: Message, state: FSMContext, bot: Bot):
    new_username = message.text.strip()
    logger.info(f"Користувач {message.from_user.id} змінює Username на: {new_username}")
...
# Обробник натискання звичайних кнопок у підрозділі "Допомога"
@router.message(MenuStates.HELP_MENU)
async def handle_help_menu_buttons(message: Message, state: FSMContext, bot: Bot):
    user_choice = message.text
    logger.info(f"Користувач {message.from_user.id} обрав {user_choice} в меню Допомога")
